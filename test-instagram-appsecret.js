...
// Test Instagram API with appsecret_proof
async function testInstagramAppSecret() {
  ...
  console.log('🔍 Testing Instagram appsecret_proof...');
  ...
  try {
    ...
    const mediaData = {
      ...
      media_type: 'IMAGE',
      appsecret_proof: appSecretProof,
      caption: 'Test post from AutoPromoter - Testing appsecret_proof functionality! 🚀 #Test #AutoPromoter #API'
    };
...
// Run the test
testInstagramAppSecret().catch(console.error);
